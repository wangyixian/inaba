...
public class MainMenuTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        try {
            ...
            ChannelDao cmsChannelDao = (ChannelDao) SpringUtil.getBean(sc, SpringConstant.CMS_CHANNEL_DAO);
            
            List<ChannelDto> channels = cmsChannelDao.selectByParentID(0);
            out.println("<ul id='mainmenu'>");

            for (ChannelDto item : channels) {
                out.println(" <li>");

...
public class ContentListTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        try {
            ...
            ContentDao cmsContentDao = (ContentDao) SpringUtil.getBean(sc, SpringConstant.CMS_CONTENT_DAO);
            ...
            List<ContentDto> contents = cmsContentDao.selectByChannelPath(channelPath, page);

            for (ContentDto item : contents) {
                out.println("<li>");
